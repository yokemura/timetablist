...
Future<void> showSlotCategoryCreateSheet(BuildContext context) {
  return showModalBottomSheet<void>(
    context: context,
    isScrollControlled: true,
    constraints: const BoxConstraints(maxWidth: 480),
    builder: (_) => const SlotCategoryCreateSheet(),
  );
}

/// Bottom sheet that creates a slot category (枠タイプ).
///
...
/// defaults to on.
class SlotCategoryCreateSheet extends ConsumerStatefulWidget {
  const SlotCategoryCreateSheet({super.key});

  @override
  ConsumerState<SlotCategoryCreateSheet> createState() =>
      _SlotCategoryCreateSheetState();
}

class _SlotCategoryCreateSheetState
    extends ConsumerState<SlotCategoryCreateSheet> {
      ...
      child: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(s.slotCategoryCreateTitle, style: theme.textTheme.titleMedium),
